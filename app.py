...
2. Imagery processing type (RGB, NDVI, Surface WATER, LULC, LST, or OPEN BUILDINGS).
   - If the user mentions "building heights" or "buildings", use OPEN BUILDINGS.
...
Processing: [RGB or NDVI or Surface WATER or LULC or LST or OPEN BUILDINGS]
